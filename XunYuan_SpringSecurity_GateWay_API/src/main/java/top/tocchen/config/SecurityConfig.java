...
import top.tocchen.result.RestAuthenticationEntryPoint;
import top.tocchen.result.RestfulAccessDeniedHandler;
...
//                .permitAll()
    ...
    @Bean
    public XunYuanUserDetailsService userDetailsService() {
        //获取登录用户信息
//        return username -> {
//            UserAuthVO userAuthVO = adminService.getAdminByUsername(username);
//            if (userAuthVO != null) {
//                return new AdminUserDetails(userAuthVO);
//            }
//            throw new UsernameNotFoundException("用户名或密码错误");
//        };
        return new XunYuanUserDetailsService() {
            @Override
